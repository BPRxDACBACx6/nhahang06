    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-home"></i>Bảng Điều Khiển
          <a href="#addModal" class="btn btn-info" data-toggle="modal">Thêm Nhóm Mới</a>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Thành Viên Nhóm</a>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  Bạn có chắc chắn muốn xóa <?php echo $team;?>?
                    </div>                     
                  <!-- Buttons -->
...
<div id="update<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Cập Nhật Thành Viên Nhóm</h4>
            </div>
            <div class="modal-body" style="height:200px">
              ...
              <form class="form-horizontal" method="post" action="team_member_update.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="title">Tên Nhóm</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="team" id="title" placeholder="Nhập tên nhóm..." value="<?php echo $menu;?>">
                      </div> 
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="username">Thành Viên</label>
                      <div class="col-lg-8"> 
                        <select class="form-control select2 " id="exampleSelect1" name="members[]" multiple='multiple' style="width: 100%;height:200px" placeholder="Lựa chọn">
                        <?php
...
<div id="addModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Thêm Nhóm Và Thành Viên Mới</h4>
            </div>
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="team_member_save.php">
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="title">Tên Nhóm</label>
                      <div class="col-lg-8"> 
                  ...
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="username">Thành Viên</label>
                      <div class="col-lg-8"> 
                        <select class="form-control select2 " id="exampleSelect1" name="members[]" multiple='multiple' style="width: 100%;height:200px" placeholder="Lựa chọn">
                         <?php
                              $result = mysqli_query($con,"SELECT * FROM member where member_status='active' ORDER BY member_last"); 
