...
<div class="content" style="margin-top:10px">
    ...
    <div class="mainbar">
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-home"></i>Trangg Điều Khiển</h2>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                    <a href="#addModal" class="btn btn-info" data-toggle="modal">Thêm Danh Mục Mới</a>
                  </div>
            ...
            <div class="modal-body" style="height:100px">
              ...
              <form class="form-horizontal" method="post" action="category_update.php">
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="title">Tên Danh Mục</label>
                      <div class="col-lg-10"> 
                        <input type="hidden" name="id" value="<?php echo $id;?>">
                        <input type="text" class="form-control" name="category" id="title" placeholder="Tên Danh Mục" value="<?php echo $name;?>">
                      </div>
                  </div> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  Bạn có chắc chắn muốn xóa danh mục <?php echo $name;?>?
                    </div>                     
                  <!-- Buttons -->
                  <div class="form-group">
                      <!-- Buttons -->
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Thêm Sự Kiện Mới</h4>
            </div>
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="category_save.php">
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="title">Tên Danh Mục</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="category" id="title" placeholder="Nhập tên danh mục..." required>
                      </div>
                  </div> 
