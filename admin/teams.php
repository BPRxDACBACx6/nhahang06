    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Nhóm</a>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Cập Nhật Chi Tiết Nhóm</h4>
            </div>
            <div class="modal-body" style="height:100px">
              ...
              <form class="form-horizontal" method="post" action="team_update.php">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="team" id="title" placeholder="Nhập tên nhóm của bạn..." value="<?php echo $team;?>">
                      </div>
                  </div> 
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="team_save.php">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="team" id="title" placeholder="Nhập tên nhóm của bạn..." required>
                      </div>
                  </div> 
