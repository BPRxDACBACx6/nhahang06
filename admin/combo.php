...
<div class="content" style="margin-top:10px">
    ...
    <div class="mainbar">
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-home"></i>Bảng Điều Khiển
          <a href="#addModal" class="btn btn-info" data-toggle="modal">Thêm Combo Mới</a>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Combo</a>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  Bạn có chắc chắn muốn xóa <?php echo $name;?>?
                    </div>                     
                  <!-- Buttons -->
            ...
            <div class="modal-body" style="height:300px">
              ...
              <form class="form-horizontal" method="post" action="combo_update.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="title">Tên Combo</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="name" id="title" placeholder="Nhập tên combo..." value="<?php echo $name;?>">
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="price" id="title" placeholder="Nhập giá của combo..." value="<?php echo $price;?>">
                      </div>
                  </div> 
                  <!-- Title -->
                  <!-- Title -->
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <select class="form-control select2 " id="exampleSelect1" name="menu[]" multiple='multiple' style="width: 100%;height:200px" placeholder="Lựa chọn">
                        <?php
...
<div id="addModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Thêm Combo Mới</h4>
            </div>
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="combo_save.php">
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-3" for="title">Tên Combo</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="name" id="title" placeholder="Nhập tên combo...">
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-3" for="title">Giá</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="price" id="title" placeholder="Nhập giá của combo...">
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
