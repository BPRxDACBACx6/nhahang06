		...
		<div class = "content">
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Lựa chọn Combo/s</div>
...
?>    
          <div class="col-md-4">
              <div class="widget">
                <!-- Widget title -->
                <div class="widget-head">
                  <div class="pull-left">Non-Combo</div>
                  <div class="widget-icons pull-right">
                  </div>  
                ...
                <div class="widget-content referrer">
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    <tbody>
                      <tr>
                      <td><input type="number" class="form-control" placeholder="Số lượng đặt hàng" name="nop[]"></td>
                    </tr> 
                    <tr>
                      <td>

               
                <select class="form-control select2 " id="exampleSelect1" name="menu[]" placeholder="Lựa chọn nhiều thành viên">
