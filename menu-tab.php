    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <!-- Logo. -->
          <div class="logo">
           <a href="index.php"> <h2 class = "logo-text" style="font-family:American Typewriter, serif"><span class="bold">Nhà Hàng 06</span></h2></a>	
        ...
        <div class="col-md-7">
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="dropdown dropdown-big">
                ...
                <i class="fa fa-pencil"></i>Lịch Đặt Bàn
              </a>                
            </li> 
			<!-- Members button with number of latest members count -->
            <li class="dropdown dropdown-big">
