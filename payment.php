        ...
        <div class = "col-md-9 col-lg-9">
          <div class="widget wgreen">
                ...
                <div class="widget-head">
                  <div class="pull-left">Chi tiết thanh toán</div>
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="payment_save.php" method="post">
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Chi tiết gói</label>
                                  <div class="col-lg-5">
<?php 
...
?>
    ...
    <?php }?>                           
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Chi tiết thanh toán</label>
                                  <div class="col-lg-5">
                                  <h4>
                                    <?php
                                      echo $row['pax'];
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <select class="form-control select2 " id="exampleSelect1" name="mode" placeholder="Lựa chọn phương thức thanh toán" required>
