...
if (isset($_POST['submit'])) {
 $email = mysqli_real_escape_string($conn, $_POST['email']);
    ...
    if ($email == "email") {
        $errormsg = "Email không được nhập";
    } else { 
...
<body class="background">
	...
	<div id="wrapper">
		<div id="login" class="animate form">
         ...
         <div id="settingLogin">
            <h1 style="top:-54%; position: absolute; left:15%; font-family: 'FranchiseRegular','Arial Narrow',Arial,sans-serif; display: bold; font-size: 40px;">Đặt Lại Mật Khẩu</h1>
