...
if (isset($_POST['register'])) {
    ...
    if (preg_match("/^[a-zA-Z ]+$/", $lastname)) {
     ...
     if (preg_match("/^[0-9]+$/", $phone)) {
        $error = false;
     $lname_error = "*Số điện thoại chỉ được chứa số.";}
    ...
    if (preg_match("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$", $email)) {
     ...
     if (preg_match("^[a-zA-Z ]+(\.[_a-z0-9-]+)$", $address)) {
        $error = false;
        $email_error = "*Vui lòng nhập địa chỉ hợp lệ";
    }
		...
		<div id="login" class="animate form">
         ...
         <div id="setting">
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="registerform">
                       ...
                       Email:<input type="text"  width=200px class="text" name="email" placeholder="Nhập email của bạn..." required value="<?php if ($error) echo $email; ?>"/>
                            ...
                            <p style="color: #FF0000; font-weight: bold; font-size: 24px"><?php if (isset($address_error)) echo $address_error; ?></p>
                             ...
                             Mật Khẩu:<input type="password"  width=200px class="text" name="password" size="37" placeholder="Nhập mật khẩu của bạn..." required>
                            <p style="color: #FF0000; font-weight: bold; font-size: 24px"><?php if (isset($password_error)) echo $password_error; ?></p>
                             
                            Nhập Lại Mật Khẩu:<input type="password" width=200px  class="text" size="37" name="cpassword" placeholder="Nhập lại mật khẩu của bạn..." required>
