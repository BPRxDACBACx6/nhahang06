...
$error = false;
		...
		if (strlen($opassword) < 6) {
                $error = true;
                $opassword_error = "*Mật khẩu phải có ít nhất 6 ký tự.";
                }
                if (strlen($npassword) < 6) {
                $error = true;
                $npassword_error = "*Mật khẩu phải có ít nhất 6 ký tự.";
                }
		...
		$querychange = mysqli_query($conn, "update user set password='".$cpassword."' where email='" . $email . "'");
				...
				$successmsg = "Bạn đã đổi mật khẩu thành công."; 
		...
		<div id="login" class="animate form">
         ...
         <div id="settingLogin">
             ...
             <br><form action="" method="post">
               ...
               <div>
                   Mật khẩu hiện tại:<input type="password" width=200px class="text" name="opassword" size="37"placeholder="Nhập mật khẩu hiện tại..." required value="<?php if ($error) echo $opassword; ?>"  id="active"/>
                        <p style="color: #FF0000; font-weight: bold; font-size: 24px"><?php if (isset($opassword_error)) echo $opassword_error; ?></p> 
                        </div>
                        <div>
                            Mật khẩu mới:<input type="password" width=200px  class="text" name="npassword" size="37" placeholder="Nhập mật khẩu mới..." required value="<?php if ($error) echo $npassword; ?>"/>
                            <p style="color: #FF0000; font-weight: bold; font-size: 24px"><?php if (isset($npassword_error)) echo $npassword_error; ?></p>
                        </div>
                        <div>
                       Nhập lại mật khẩu mới:<input type="password"  width=200px class="text" name="cpassword" placeholder="Nhập lại mật khẩu mới..." required value="<?php if ($error) echo $cpassword; ?>"/>
                       <p style="color: #FF0000; font-weight: bold; font-size: 24px"><?php if (isset($cpassword_error)) echo $cpassword_error; ?></p></div>
                <br>
                <p class="login button"><input type="submit" name="submit" value="Lưu"/></p>
                 <div> 
                     ...
                     <div style="top:660%; position: absolute; left:49%; font-family: 'FranchiseRegular','Arial Narrow',Arial,sans-serif; display: bold; font-size: 20px;">
                         <a href="home.html"><b>Trang Chủ</b></a>
                     </div>
