		...
		<div class = "content">
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Chi tiết Combo</div>
...
?>          
        <div class="form-group">
            <label class="control-label col-lg-4" for="username">Chọn<?php echo $row1['cat_name'];?></label>
            <div class="col-lg-8"> 
                <input type="hidden" value="<?php echo $rdid;?>" name="rdid[]">
                <select class="form-control select2 " id="exampleSelect1" name="menu[]" placeholder="Chọn nhiều thành viên">
                  <?php
